...
function sea_process_css($css, $theme) {
    ...
    $css = sea_set_regionwidth($css, $regionwidth);
    ...
    $css = sea_set_customcss($css, $customcss);
 ...
 * @return string
 */
function sea_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function sea_set_customcss($css, $customcss) {
